        ...
        for locName, coords in self.locations.items():
            ...
            for step in stepValues:
                ...
                if hasStepIndex is True:
                    nearestPointVal = ncFile.sel(step=step, latitude=lat, longitude=lon, method="nearest")[
                        ncVarName
                    ].values
                else:
                    nearestPointVal = ncFile.sel(latitude=lat, longitude=lon, method="nearest")[ncVarName].values
